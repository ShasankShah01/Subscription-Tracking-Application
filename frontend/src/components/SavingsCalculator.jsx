...
export default function SavingsCalculator({ onDashboardClick }) {
  ...
  return (
    <section id="calculator" className="py-24 border-b border-slate-800/60 relative overflow-hidden">
      {/* Glow sphere */}
      <div className="absolute top-1/2 right-10 -translate-y-1/2 w-[500px] h-[500px] bg-emerald-500/10 rounded-full blur-[160px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto rounded-3xl bg-slate-900/60 border border-slate-800 p-8 sm:p-12 backdrop-blur-xl shadow-2xl grid md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 space-y-8">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="font-black text-cyan-400 bg-cyan-500/10 px-3 py-1 rounded-xl border border-cyan-500/20">
                  {subCount} services
                </span>
              </div>
              <input
          ...
          <div className="md:col-span-5 rounded-2xl bg-slate-950 p-6 sm:p-8 border border-slate-800 flex flex-col justify-between text-center relative overflow-hidden shadow-inner">
            <div className="space-y-6">
              <div className="border-b border-slate-800 pb-4">
                <div className="text-xs uppercase font-bold tracking-wider text-slate-400">Total Monthly Spend</div>
              ...
              <div>
                <div className="text-xs uppercase font-bold tracking-wider text-slate-400">Estimated Annual Savings</div>
                <div className="text-4xl sm:text-5xl font-black bg-gradient-to-r from-emerald-400 via-teal-300 to-cyan-400 bg-clip-text text-transparent mt-2">
                  ${annualSavings.toLocaleString()}
                </div>
                <div className="text-[11px] text-slate-500 mt-1">per year back in your pocket</div>
              </div>
            </div>

            <button
              onClick={onDashboardClick}
              className="mt-8 w-full py-4 rounded-xl font-bold text-sm text-slate-950 bg-gradient-to-r from-cyan-400 via-teal-300 to-emerald-400 shadow-xl shadow-cyan-500/20 hover:shadow-cyan-500/40 hover:scale-105 active:scale-95 transition-all duration-300"
            >
